...
class AutoPage(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # ======== Entry Boxes ========
        self.wait_label = ctk.CTkLabel(self, text="Waiting Time (minutes):", font=ctk.CTkFont(size=14))
        ...
        self.loop_label = ctk.CTkLabel(self, text="Loop Count:", font=ctk.CTkFont(size=14))
        ...
        # ======== ESP32 Config ========
        self.esp32_ip = "172.20.10.3"  # 🔧 Change to your ESP32 IP

    def send_data_to_esp(self):
        wait_time = self.wait_entry.get()
        loop_count = self.loop_entry.get()
        identifier = "AGV1"  # Can be dynamic if needed
        ...
        try:
            ...
            # Send request in a separate thread to avoid freezing GUI
